...
public class SQL extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LoginBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkginterface/ywca1.png"))); // NOI18N
        LoginBackground.setText("");
        LoginBackground.setAutoscrolls(true);
        getContentPane().add(LoginBackground);
        LoginBackground.setBounds(0, 0, 400, 300);

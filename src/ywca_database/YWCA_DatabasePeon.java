 ...
 * @author Kyle
 */
public class YWCA_DatabasePeon extends javax.swing.JFrame {

    /**
     * Creates new form YMCA_Database
     */
    public YWCA_DatabasePeon() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(YWCA_DatabasePeon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new YWCA_DatabasePeon().setVisible(true);
            }
        });
    }
